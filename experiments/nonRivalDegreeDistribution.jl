...
function parse_commandline()
    ...
    @add_arg_table! s begin
        "-N"
            ...
            arg_type = Int
      		required = true
<<<<<<< HEAD:experiments/baseCoopWins.jl
      	"--fitness"
      	...
      	"--defcost"
      		...
      		default = 0.2
=======
>>>>>>> parent of f33646f... Using commandline options to make things a lot more modular. Added degree distribution simulation code, as well as another judging rule.:experiments/nonRivalDegreeDistribution.jl
    end
